...
echo "   See docs/mcp-setup.md for the canonical server list and sync checklist."
echo "   After cloning:"
echo "   1. Install Docker Desktop (required for terraform-mcp)"
echo "   2. Open the project in Cursor or VS Code"
echo "   3. Run: npm run dev (required for vite MCP)"
echo "   4. Restart the IDE so MCP servers load"
echo "   5. (Optional) Set TFE_TOKEN / TFE_ADDRESS for Terraform registry"
